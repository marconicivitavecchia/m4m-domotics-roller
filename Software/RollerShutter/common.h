...
#define RSTTIME		40		//DEFINE HOW MANY SECONDS BUTTON1 MUST BE PRESSED UNTIL A RESET OCCUR 
#define CNTIME		4		//DEFINE HOW MANY SECONDS 
...
#define SWITCHND 	5		//OVERALL NUMBER OF SWITCHES (FUNCTION SWITCHES + SPECIAL SWITCHES) 
...
#define CNTIMER1	2		//INDEX OF AP TIMER (DETECTS IF A AP ACTIVATION COMMAND OCCUR)
#define CNTIMER2	3		//INDEX OF AP TIMER (DETECTS IF A AP ACTIVATION COMMAND OCCUR)
