...
class HLW8012 {
    ...
    public:
        ...
        void resetEnergy();
		unsigned int getExtimActivePower(); //my func by Seby 07/08/19
		unsigned int getAvgdExtimActivePower(); //my func by Seby 07/08/19
    ...
    private:
		...
		volatile unsigned long _summed_pulse_width = 0;		//Unit: us, my proper by Seby 07/08/19
		volatile unsigned long _avg_pulse_count = 0;		//my proper by Seby 07/08/19
